      ...
      {isProduct.map((item) => (
        ...
        >
          ...
          <div className="w-[100%] pt-[20px] flex items-center justify-between">
            <button className="w-[180px] h-[35px] text-white border-none rounded-lg bg-[#006bff] z-40  relative gap-2 after:w-0 after:h-10 after:absolute after:top-0 after:hover:w-[180px] after:hover:h-[35px]  transition after:duration-200 after:ease-in-out  after:rounded-lg after:left-0  after:bg-[#0d00ff]">
