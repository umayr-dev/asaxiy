  ...
  return (
    ...
    <div className="mx-auto max-w-[1380px] bg-white rounded-[12px] p-[20px] h-[140px] flex justify-between items-center">
        <div className="flex items-center gap-5 ">
            <Image height={24} width={24} src="https://asaxiy.uz/custom-assets/images/icons/market.svg" alt="" />
        ...
        <div className="flex items-center gap-5 ">
            <Image height={24} width={24} src="https://asaxiy.uz/custom-assets/images/icons/return.svg" alt="" />
        ...
        <div className="flex items-center gap-5 ">
            <Image height={24} width={24} src="https://asaxiy.uz/custom-assets/images/icons/fast-delivery.svg" alt="" />
            <p className="flex flex-col w-[300px] ">
                <Link href={"/"} className="text-[15px] font-[600] text-blue-950">Tez yetkazib berish</Link>
                <span className="text-[14px] text-gray-500">Bizda qulay narxlar va uyga yetkazib berish mavjud</span>
            </p>
        ...
        <div className="flex items-center gap-5 ">
            <Image height={24} width={24} src="https://asaxiy.uz/custom-assets/images/icons/card.svg" alt="" />
            <p className="flex flex-col w-[300px] ">
                <Link href={"/"} className="text-[15px] font-[600] text-blue-950">Tez yetkazib berish</Link>
                <span className="text-[14px] text-gray-500">Bizda qulay narxlar va uyga yetkazib berish mavjud</span>
            </p>
