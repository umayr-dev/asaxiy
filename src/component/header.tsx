...
const Header = () => {
  ...
  return (
    <div className=" bg-white sticky z-50 top-0 left-0 right-0 bottom-0">
      <header className=" border-[1px]">
        <div className="mx-auto max-w-[1380px] h-[80px] header-top items-center flex   justify-between ">
          ...
          <div className="w-[480px] h-9 flex pl-2 items-center border-2 rounded-lg justify-between border-[#006bff]">
            ...
            />
            <button className="w-[80px] text-white h-9 rounded-tr-lg rounded-br-lg bg-[#006bff]">
              Qidirish
            </button>
          </div>
          <p
            onClick={() => router.push("/")}
            className="flex cursor-pointer text-[14px] flex-col
          ...
          <p
            className="flex flex-col cursor-pointer text-[14px] hover:text-[#006bff] transition-all
              items-center"
          >
            <Image
              height={24}
      ...
      <header className="mx-auto max-w-[1380px] flex justify-between h-12 items-center">
        {categories.map((item) => (
          <Link
            className="hover:text-[#006bff] transition duration-200"
            key={item.id}
            href={"/categories"}
          >
            {item.name}
