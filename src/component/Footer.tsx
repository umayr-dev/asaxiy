    ...
    <footer className="bg-white pt-5 pb-5">
      <div className="mx-auto max-w-[1380px] pb-6 flex justify-between border-b">
        ...
        <div className="flex flex-col gap-2 text-[16px] text-gray-600">
          ...
          >
            <Image
              height={24}
              width={24}
              src="/location-plus.png"
              alt="location"
            />
            Islom Karimov, 49, Toshkent
          </a>
          <h1 className="text-black font-[600] text-[20px] mt-7">
            Sodiqlik dasturlari
          </h1>
          <Link
            className="hover:text-[#006bff] transition duration-200"
        ...
        <div className="flex flex-col gap-4 text-[16px]">
          <h1 className="text-black font-[600] text-[20px]">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              >
                <Image
                  src={`https://asaxiy.uz/custom-assets/images/${src}`}
                  alt={src}
                  width={40}
                  height={0}
                />
          ...
          <div className="flex items-center gap-3">
            {[
              {
                href: "https://www.facebook.com/asaxiyshop/",
